      ...
      <div style={{ backgroundcolor: "rgb(228, 209, 187)", marginTop: "5vh" }}>
        <footer class="bg-dark text-center text-white">
          <div class="container p-3">
            ...
            <section class="mb-4">
              <p>
               ROLEX GIVES YOU A CONFIDENCE TO WEAR IT
              ...
              <div class="row">
                <div class="col-lg-7 col-md-6 mb-4 mb-md-0">
                  ...
                  <ul class="list-unstyled mb-0">
                    ...
                    <li>
                      <Link to="/steel" class="text-white">
                      STEEL WATCHES
                      </Link>
                    </li>
                    <li>
                      <Link to="/gs" class="text-white">
                      STEEL & GOLD
                      </Link>
                    </li>
                    <li>
                      <Link to="/gold" class="text-white">
                      GOLD WATCHES
                      </Link>
                    </li>
                    <li>
                      <Link to="/gem" class="text-white">
                      GEM SET WATCHES
                      </Link>
                    </li>
                  </ul>
