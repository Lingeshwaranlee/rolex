...
export function Oyster() {
  ...
  return (
    <div>
      <div>
        <h2 style={{ textAlign: "center", fontSize: "70px" }}>OYSTER PERPETUAL</h2>
    ...
    <div className="hover1" style={{ padding: "2px" }}>
        ...
        >
          <h1 style={{ color: "crimson" }}>OYSTER PERPETUAL
          </h1>
          ...
          THE OYSTER PERPETUAL GMT-MASTER II IN 18 CT WHITE GOLD WITH AN OYSTER BRACELET.This model features a meteorite dial and a two-colour Cerachrom bezel insert in red and blue ceramic. Designed to show the time in two different time zones simultaneously during intercontinental flights, the GMT-Master II has come to be recognized for its robustness and versatile appearance.
            ...
            <h2>
              ...
              <span style={{ color: "crimson" }}>OYSTER PERPETUAL</span>
            </h2>
          </h4>
        </div>
        <div>
          <img
            ...
            src="https://www.bexsonn.com/wp-content/uploads/2020/09/ZCB_3827.jpg"
          ></img>
        </div>
      </div>
      </div>
      ...
      <div className="rolex-list">
        <div className="zoom" style={{ textAlign: "center" }}>
          <img
            ...
            src="https://content.rolex.com/dam/2022/upright-bba-with-shadow/m124300-0001.png?imwidth=420"
          ></img>
          <h5>OYSTER PERPETUAL 41</h5>
        ...
        <div className="zoom" style={{ textAlign: "center" }}>
          <img
            className="poster-modal1"
            src="https://content.rolex.com/dam/2022/upright-bba-with-shadow/m277200-0004.png?imwidth=420"
          ></img>
          <h5>OYSTER PERPETUAL 36</h5>
        ...
        <div className="zoom" style={{ textAlign: "center" }}>
          <img
            className="poster-modal1"
            src="https://content.rolex.com/dam/2022/upright-bba-with-shadow/m126000-0006.png?imwidth=420"
          ></img>
          <h5>OYSTER PERPETUAL 40</h5>
          <p>oyser,40 mm ,oystersteel</p>
          <p>
            <BiRupee />
            75,500
